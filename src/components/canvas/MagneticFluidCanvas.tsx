...
/**
 * @component MagneticFluidMesh
 * @description A high-fidelity WebGL simulation of ferrofluid-like behavior.
 * Uses a complex displacement map driven by cursor proximity and multi-layered noise.
 */
const MagneticFluidMesh = () => {
            ...
            <shaderMaterial
                ...
                vertexShader={`
                    ...
                    void main() {
                        ...
                        // Ferrofluid behavior: cursor pulling and noise spikes
                        float dist = distance(pos.xy, uMouse);
                        float pull = smoothstep(6.0, 0.0, dist) * 2.5;
                        
                        float noise = pnoise(vec3(pos.xy * 0.3, uTime * 0.4), vec3(10.0));
                        float distortion = noise * 1.2 + pull * (noise + 1.0);
