...
export default function ContactFooter() {
    ...
    return (
        <section ref={containerRef} id="contact" className="relative w-full min-h-screen bg-[#050505] flex flex-col items-center justify-center px-6 py-32 overflow-hidden">
