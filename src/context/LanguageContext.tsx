...
const translations: Translations = {
  ...
  'about.important': {
    en: "Ilyas,Nour,Morocco,Animy,PrivaFlow,Masterwork",
    fr: "Ilyas,Nour,Maroc,Animy,PrivaFlow,Masterwork",
    es: "Ilyas,Nour,Marruecos,Animy,PrivaFlow,Masterwork"
  },
